...
namespace AdvancedDataStructures
{
    ...
    public sealed class LruCache<TKey, TValue>
    {
        ...
        private int FindEntry(TKey key)
        {
            ...
            for (int i = _buckets[hashCode % unchecked((uint)_buckets.Length)];
                 i != -1;
                 i = _entries[i].Next)
            {
        ...
        private void UpdateEntryForInsert(int index, ref Entry entry, uint bucket, uint hashCode,
        ...
        private static class LruCacheHelpers
        {
            // Ripped from the reference source
            public static readonly int[] Primes =
            {
                ...
                156437,
                187751, 225307, 270371, 324449, 389357, 467237, 560689, 672827, 807403, 968897,
                1162687, 1395263,
                1674319, 2009191, 2411033, 2893249, 3471899, 4166287, 4999559, 5999471, 7199369
            };

            public static int ExpandToPrime(int capacity)
            {
